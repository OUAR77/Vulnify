    ...
    <>
      {!open && (
        <motion.button
          ...
          className="size-14 rounded-full bg-gradient-to-br from-zinc-200 to-white text-black flex items-center justify-center shadow-lg hover:scale-110 transition-all cursor-pointer relative"
          whileHover={{ rotate: -8 }}
