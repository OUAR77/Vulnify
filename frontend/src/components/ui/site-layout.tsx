                    ...
                    <li key={link.label}>
                      {link.label === 'Sobre nosotros' ? (
                        <button
                          ...
                          className="text-sm text-zinc-300 hover:text-white transition-colors bg-transparent border-none cursor-pointer p-0"
                        >
                          {link.label}
                        </button>
                      ) : (
                        <Link to={link.to} className="text-sm text-zinc-300 hover:text-white transition-colors no-underline">
                          {link.label}
                        </Link>
                      )}
                    </li>
