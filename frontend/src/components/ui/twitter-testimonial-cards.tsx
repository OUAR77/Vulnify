  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      handle: "@cmendoza",
      content: "Vulnify transformó nuestra web en una máquina de ventas. Pasamos de 5 a 40 leads al mes sin invertir en anuncios. La IA integrada es un antes y después.",
      date: "Mar 10, 2026",
      verified: true,
      likes: 89,
      retweets: 12,
    ...
    },
    {
      ...
      handle: "@laurag_tech",
      content: "El proceso de trabajo fue increíble. En 3 semanas teníamos nuestra web lista con chatbot IA incluido. El equipo súper profesional y transparente.",
      date: "Feb 22, 2026",
      verified: true,
      likes: 62,
      retweets: 8,
    ...
    },
    {
      ...
      handle: "@mangelruiz",
      content: "Automatizamos todo nuestro reporting con el dashboard que nos hicieron. Ahora tenemos datos en tiempo real y el equipo ahorra 20h semanales. Brutal.",
      date: "Feb 8, 2026",
      verified: true,
      likes: 234,
      retweets: 45,
